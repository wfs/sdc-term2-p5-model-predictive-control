            ...
            if (s != "") {
                ...
                if (event == "telemetry") {
                    ...
                    */
                    ...
                    // Adapted fellow student's (mvirgo) latency implementation here:
                    // See blog - https://medium.com/towards-data-science/dude-wheres-my-car-looking-back-at-udacity-sdcnd-term-2-e518fede30a1
                    // See "Accounting for Latency" - https://github.com/mvirgo/MPC-Project
